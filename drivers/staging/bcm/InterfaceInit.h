...
#define BCM_USB_VENDOR_ID_ZFG	0x19d2
...
#define BCM_USB_PRODUCT_ID_ZFG_226 0x172
#define BCM_USB_PRODUCT_ID_ZFG_326 0x173 
#define BCM_USB_PRODUCT_ID_ZFG_TU25	0x0007

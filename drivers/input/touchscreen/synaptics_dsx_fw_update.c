...
#define FW_IMAGE_NAME_JDI "PR1730750-td4291-jdi-3031.img"
...
static int fwu_start_reflash(void)
{
	...
	if (fwu->ext_data_source) {
    	...
    	switch (fwu->productinfo1){
         //DSX_UP("Enter %s@%d: Start of reflash process,fwu->productinfo1=0x%x\n", __func__,__LINE__,fwu->productinfo1);			
        case 0x01:
            printk("%s:tdi\n",__func__);
...
extern void synaptics_create_auto_update_fw_work(void);
#endif
